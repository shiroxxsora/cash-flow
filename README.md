...
Если будете добавлять новые записи лучше всего залогиниться на странице your.domain/admin, your.domain по умолчанию установлен 127.0.0.1:9000
...
---------------------------------------
**Создание записи в таблице пересечения подкатегории и записи ДДС**
...
---------------------------------------
**Удаление записи в таблице пересечения подкатегории и записи ДДС**
